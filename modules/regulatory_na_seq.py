...
class RegulatoryNaSeq(models.Model):

    class Meta:
        db_table = "regulatory_na_sequence"
    ...
    reg_class = models.CharField(255)
    ...
    def insert(cls,
        ...
        if source_type == "GenBank":
            ...
            gene_symbol = None
            if "regulatory_class" in vars(feature):
                gene_symbol = m.Pg.clean_text_value(feature.regulatory_class)
